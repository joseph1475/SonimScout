...
class TestRestrictUSB(BaseClass):

    def test_USBSettings(self):
        ...
        self.driver1.find_element_by_android_uiautomator(
            "new UiSelector().textContains(\"USB Restriction\")").click()
        ...
        Settingsdriver.find_element_by_android_uiautomator(
            ...
            "scrollable(true).instance(0)).scrollIntoView(new UiSelector().textContains(\"" + "Connected devices" + "\").instance(0))");
        time.sleep(5)
        Settingsdriver.find_element_by_android_uiautomator(
            "new UiSelector().textContains(\"Connected devices\")").click()
        Settingsdriver.find_element_by_xpath("//*[@text='USB']").click()
